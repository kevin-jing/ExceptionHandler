...
namespace ExceptionHandler
{
    public class ErrorLogger
    {
        ...
        private async void CreateErrorFile()
        {
            try
            {
                _errorFile = await ApplicationData.Current.LocalFolder.CreateFileAsync("ErrorFile.txt", CreationCollisionOption.OpenIfExists);
            }
            catch (Exception)
            {
    ...
    sealed partial class App : Application
    {
        ...
        {
            Task t = Logger.WriteMessage(e.Exception.ToString());
